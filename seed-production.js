 ...
 * with an admin user and all demo venues from mockData.js.
 */
...
// --- 3. VENUES (Manually synced from mockData.js to avoid ESM import issues) ---
const VENUES = [
...
async function seed() {
  try {
    ...
    // ── Create venues ────────────────────────────────────────────────────────
    console.log('🏟️  Migrating venues from mockData...');
    let created = 0;
    let skipped = 0;
    ...
    console.log(`✅ Success: ${created} created, ${skipped} already in production.`);
